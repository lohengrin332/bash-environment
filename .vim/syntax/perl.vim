...
if exists("perl_include_pod")
  ...
  if exists("perl_fold") || exists("perl_fold_pod") || exists("perl_fold_comment")
  ...
  if exists("perl_fold") || exists("perl_fold_pod")
...
"if exists("perl_fold") || exists("perl_fold_comment")
"  syn region perlCommentFold start="^\s*#" end="^\s*[^#]" fold
"else
"  syn region perlCommentFold start="^\s*#" end="^\s*[^#]"
"endif
